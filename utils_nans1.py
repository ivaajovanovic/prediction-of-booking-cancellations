...
def check_outliers_iqr(data: pd.DataFrame, threshold: float = 1.5):
    '''
    Checks for strongly influential outliers using the Interquartile Range (IQR) method.

    Args:
    - data: DataFrame containing the features.
    - threshold: Threshold for identifying outliers. Default is 1.5.

    Returns:
    - outlier_indices: Indices of strongly influential outliers.
    '''
    ...
    outlier_indices = ((data < (Q1 - outlier_step)) | (data > (Q3 + outlier_step))).any(axis=1)
